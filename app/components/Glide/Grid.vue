...
<template>
  <svg id="glide-grid" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 935 425" class="absolute -left-2 -top-14 -z-10" opacity="0" style="mask-image: linear-gradient(black, transparent)">
