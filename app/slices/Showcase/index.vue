...
defineProps(getSliceComponentProps<Content.ShowcaseSlice>(["slice", "index", "slices", "context"]));
...
<template>
  <Bounded :data-slice-type="slice.slice_type" :data-slice-variation="slice.variation">
    ...
    <heading class="showcase__heading text-balance text-center text-5xl font-medium md:text-7xl">
    ...
    >
      ...
      <PrismicImage
        ...
        class="opacity-90 shadow-2xl lg:col-span-2 lg:py-0"
