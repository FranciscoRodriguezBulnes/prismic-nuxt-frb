...
onMounted(() => {
  ...
  tl.fromTo(".hero__ctas", { scale: 1.5, opacity: 0 }, { scale: 1, opacity: 1, duration: 1.2 }, "-=0.8");
...
<template>
  <Bounded :data-slice-type="slice.slice_type" :data-slice-variation="slice.variation">
    <div class="text-center relative">
      <GlideGrid />
      <h1 class="hero__heading mx-auto max-w-3xl text-balance text-5xl font-medium">
      ...
      <div class="hero__ctas flex flex-wrap gap-8 justify-center mt-8">
        <PrismicLink v-for="cta in slice.primary.ctas" :key="cta.key" class="buttonLink" :field="cta" />
      </div>
