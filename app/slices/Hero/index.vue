...
onMounted(() => {
  ...
  tl.fromTo(".hero__cta", { scale: 1.5, opacity: 0 }, { scale: 1, opacity: 1, duration: 1.2 }, "-=0.8");
  tl.fromTo(".hero__image", { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 1.2 }, "-=0.3");
...
<template>
  <Bounded :data-slice-type="slice.slice_type" :data-slice-variation="slice.variation">
    <div class="text-center relative">
      <GlideGrid />
      <h1 class="hero__heading mx-auto max-w-3xl text-balance text-5xl md:text-7xl ppfont-medium">
      ...
      <div class=" flex flex-wrap gap-8 justify-center mt-8">
        <PrismicLink v-for="cta in slice.primary.ctas" :key="cta.key" class="hero__cta buttonLink" :field="cta" />
      </div>
